...
for internal testing only. It should not be published.
  ...
  s.dependency 'FirebaseAuth', '~> 12.5.0'
  s.dependency 'FirebaseFunctions', '~> 12.5.0'
  s.dependency 'FirebaseFirestore', '~> 12.5.0'
  s.dependency 'FirebaseStorage', '~> 12.5.0'
  ...
  s.test_spec 'integration' do |int_tests|
    ...
    int_tests.dependency 'FirebaseAuth', '~> 12.5.0'
  end
end
